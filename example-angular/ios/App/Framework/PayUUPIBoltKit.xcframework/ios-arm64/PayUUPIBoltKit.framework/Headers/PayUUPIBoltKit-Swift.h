...
#ifndef PAYUUPIBOLTKIT_SWIFT_H
#define PAYUUPIBOLTKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PayUUPIBoltKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@protocol PayUUPIBoltInterface
- (void)isUpiBoltAvailableWithPg:(NSString * _Nonnull)pg callback:(void (^ _Nonnull)(PayUUPIBoltResponse * _Nonnull))callback;
...
- (void)activateAccountWithParentVC:(UIViewController * _Nonnull)parentVC accountDetail:(PayUUPIBoltAccountDetail * _Nonnull)accountDetail callback:(void (^ _Nonnull)(PayUUPIBoltResponse * _Nonnull))callback;
...
- (void)payWithParentVC:(UIViewController * _Nonnull)parentVC paymentParams:(PayUUPIBoltPaymentParams * _Nonnull)paymentParams callback:(void (^ _Nonnull)(PayUUPIBoltResponse * _Nonnull))callback;
- (void)checkTransactionStatusWithTxnId:(NSString * _Nonnull)txnId callback:(void (^ _Nonnull)(PayUUPIBoltResponse * _Nonnull))callback;
- (void)verifyTransactionStatusWithTxnId:(NSString * _Nonnull)txnId callback:(void (^ _Nonnull)(PayUUPIBoltResponse * _Nonnull))callback;
...
- (void)cancelTransactionWithCallback:(void (^ _Nonnull)(PayUUPIBoltResponse * _Nonnull))callback;
- (void)fetchVpaProfileWithVpa:(NSString * _Nonnull)vpa callback:(void (^ _Nonnull)(PayUUPIBoltResponse * _Nonnull))callback;
